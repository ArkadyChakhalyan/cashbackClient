...
export const Slide_5_3 = () => {
    return <Stack sx={containerStyle}>
        ...
        <Stack sx={contentStyle}>
            ...
            <Typography variant={'body1'} sx={textStyle}>
                В настоящее время поиск по МСС-кодам поддерживается для следующих банков: Т-Банк, Альфа, ВТБ, Яндекс, Озон, ОТП. Остальные банки будут добавляться постепенно.
            </Typography>
        </Stack>
    </Stack>;
}
