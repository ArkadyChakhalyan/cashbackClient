export const CASHBACK_ACTIONS_MOVE = 'Продублировать на следующий месяц';
export const CASHBACK_ACTIONS_MOVE_SHORT = 'Продублировать';
export const CASHBACK_ACTIONS_CODES = 'МСС кода';
